...
class {{resource.class_name}}Participance(models.Document):
	...
	data = models.DynamicField(default="") #参与数据
...
class {{resource.class_name}}(models.Document):
	...
	related_page_id = models.StringField(default="", max_length=100) #wepage page的id
	is_deleted = models.BooleanField(default=False) #活动是否被删除
	created_at = models.DateTimeField() #创建时间
