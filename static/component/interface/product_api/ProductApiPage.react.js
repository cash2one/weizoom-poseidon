			...
			<div className="mt15 xui-interface-productApiPage">
				<table className="table table-bordered" style={{width:'80%'}}>
					<tbody>
						...
						<tr>
							<td><a href="/../../../static/wiki/product_list.html">/mall/products</a></td>
							<td>获取全部商品列表</td>
						</tr>
						<tr>
							<td><a href="/../../../static/wiki/product_detail.html">/mall/product</a></td>
							<td>获取单个商品详情</td>
						</tr>
						<tr>
							<td><a href="/../../../static/wiki/product_classification.html">/mall/product_classifications</a></td>
							<td>获取商品分类</td>
						</tr>
					</tbody>
				</table>
