...
Scenario:1 管理员驳回申请
	...
	Then manager查看应用审核列表
		...
		|  耐克男鞋  |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984405|  nkshoes@qq.com |192.168.1.4|http://192.168.0.170|待审核 |确认通过/驳回修改| 
		|   周黑鸭   |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984410|    duck@qq.com  |192.168.1.23|http://192.168.0.233|待审核 |确认通过/驳回修改| 
	...
	Then manager查看应用审核列表
		|account_main|application_name|     appid    |   appsecret  |dev_name|mob_number |  email_address  | ip_address | interface_address    |statute|   operation   |
		|  爱伲咖啡  |  默认应用      |审核后自动生成|审核后自动生成|爱伲咖啡|13813984405|ainicoffee@qq.com|192.168.1.3|http://192.168.0.130|待审核 |确认通过/驳回修改|
		|  耐克男鞋  |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984405|  nkshoes@qq.com |192.168.1.4|http://192.168.0.170|已驳回 |驳回原因:ip地址不合法| 
		|   周黑鸭   |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984410|    duck@qq.com  |192.168.1.23|http://192.168.0.233|待审核 |确认通过/驳回修改| 
...
Scenario:3 被驳回再次修改
	...
	Then manager查看应用审核列表
		|account_main|application_name|     appid    |   appsecret  |dev_name|mob_number |  email_address  | ip_address | interface_address    |statute|   operation   |
		|  爱伲咖啡  |  默认应用      |审核后自动生成|审核后自动生成|爱伲咖啡|13813984405|ainicoffee@qq.com|192.168.1.3|http://192.168.0.130|待审核 |确认通过/驳回修改| 
		|  耐克男鞋  |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984405|  nkshoes@qq.com |192.168.1.28|http://192.168.0.170|待审核 |确认通过/驳回修改| 
		|   周黑鸭   |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984410|    duck@qq.com  |192.168.1.23|http://192.168.0.233|待审核 |确认通过/驳回修改| 
...
Scenario:4 激活后暂停停用
	...
	Then manager查看应用审核列表
		|account_main|application_name|     appid    |   appsecret  |dev_name|mob_number |  email_address  | ip_address | interface_address    |statute|   operation   |
		|  爱伲咖啡  |  默认应用      |   3565989    |sd124wr45sfds |爱伲咖啡|13813984405|ainicoffee@qq.com|192.168.1.3|http://192.168.0.130|已暂停 |      启用     |
		|  耐克男鞋  |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984405|  nkshoes@qq.com |192.168.1.4|http://192.168.0.170|待审核 |确认通过/驳回修改| 
		|   周黑鸭   |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984410|    duck@qq.com  |192.168.1.23|http://192.168.0.233|待审核 |确认通过/驳回修改| 
