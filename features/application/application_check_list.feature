...
Scenario:1 管理员查看应用审核列表
	...
	When manager查看应用审核列表
		...
		|  爱伲咖啡  |  默认应用      |审核后自动生成|审核后自动生成|爱伲咖啡|13813984405|ainicoffee@qq.com|192.168.1.3|http://192.168.0.130| 
		|  耐克男鞋  |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984405|  nkshoes@qq.com |192.168.1.4|http://192.168.0.170| 
		|   周黑鸭   |  默认应用      |审核后自动生成|审核后自动生成|耐克男鞋|13813984410|    duck@qq.com  |192.168.1.23|http://192.168.0.233| 
